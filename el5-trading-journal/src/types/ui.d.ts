declare module '@/components/ui/select' {
  ...
  export const SelectItem: React.FC<{ children?: React.ReactNode; value?: any; className?: string }>;
  ...
  export const SelectValue: React.FC<{ children?: React.ReactNode; className?: string }>;

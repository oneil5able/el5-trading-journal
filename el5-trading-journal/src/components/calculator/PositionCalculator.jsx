    ...
    <Card className="bg-slate-900/50 border-slate-800/50 backdrop-blur-xl p-6">
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          ...
          <p className="text-slate-400 text-sm">Calculate optimal position size & risk/reward</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-3 gap-4 mb-4">
        <div>
          ...
          <Select value={direction} onValueChange={setDirection} className="bg-slate-800 border-slate-700 mt-1">
        ...
        <div>
          <Label className="text-slate-400 text-sm">Take Profit (optional)</Label>
          <Input
            type="number"
            step="0.01"
            value={takeProfit}
            ...
            {takeProfit && (
              <>
                ...
                <div className={`flex items-center justify-between p-4 rounded-xl ${
                  riskRewardRatio >= 2 ? 'bg-emerald-500/10 border border-emerald-500/20' :
                  riskRewardRatio >= 1 ? 'bg-amber-500/10 border border-amber-500/20' :
                  ...
                  <span className={`font-bold text-xl ${
                    riskRewardRatio >= 2 ? 'text-emerald-400' :
                ...
                {riskRewardRatio >= 2 && (
                  <div className="p-3 rounded-lg bg-emerald-500/10 border border-emerald-500/20">
                    <p className="text-emerald-400 text-sm">✓ Excellent risk/reward ratio! Meets 2:1 minimum.</p>
                  </div>
                )}
              </>
            )}

  ...
  const handleExit = () => {
    onExit({
      ...
      profit_loss_percent: pl
        ? (pl / (trade.entry_price * trade.quantity)) * 100
        : 0,
    });
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <Textarea
              ...
              onChange={(e) =>
                setExitData({ ...exitData, exit_notes: e.target.value })
              }
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-2 mt-2">
              {["satisfied", "neutral", "regret", "relief", "frustrated"].map(
                (emotion) => (
                  <Button
                    key={emotion}
                    variant={
                      exitData.emotion_exit === emotion ? "default" : "outline"
                    }
                    size="sm"
                    className={
                      exitData.emotion_exit === emotion
                        ? "bg-emerald-600"
                        : "border-slate-700"
                    }
                    onClick={() =>
                      setExitData({ ...exitData, emotion_exit: emotion })
                    }
                  >
                    {emotion}
                  </Button>

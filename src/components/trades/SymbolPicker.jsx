...
export const POPULAR_SYMBOLS = {
  stocks: ['AAPL','TSLA','NVDA','MSFT','GOOGL','AMZN','META','NFLX','AMD','INTC','DIS','SHOP','SQ','PYPL','UBER','NKE','V','MA','SPY','QQQ','IWM','DIA','ARKK'],
  crypto: ['BTC/USD','ETH/USD','SOL/USD','BNB/USD','XRP/USD','ADA/USD','DOGE/USD','LTC/USD','DOT/USD','AVAX/USD','SHIB/USD','MATIC/USD','LINK/USD','UNI/USD'],
  forex: ['EUR/USD','GBP/USD','USD/JPY','AUD/USD','USD/CAD','NZD/USD','USD/CHF','EUR/GBP','EUR/JPY','GBP/JPY','AUD/JPY','EUR/CHF','GBP/CHF','NZD/JPY'],
          ...
          <div className="flex flex-wrap gap-2">
            {baseSymbols.slice(0, 20).map((symbol) => (
              <Badge
                ...
                onClick={() => { onSelect(symbol); setSearch(''); setOpen(false) }}
              >
                {symbol}
              </Badge>
            ))}

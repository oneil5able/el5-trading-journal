...
export default function AnimatedHero() {
  ...
  useEffect(() => {
    ...
    ellipses.forEach((el, i) => {
      ...
      gsap.set(el, {
        opacity: 1 - a / ellipses.length,
        stroke: colorInterp(a / ellipses.length),
      });
      tl.to(el, {
        attr: { ry: `-=${a * 2.3}`, rx: `+=${a * 1.4}` },
        ease: easeB,
        duration: 1 + (i % 3) * 0.15,
      })
        .to(el, {
